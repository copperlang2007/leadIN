        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <EmptyState
                icon={Users}
                title="No agents in this org yet"
                description="Invite agents from the user list above, or share the org's signup link. As soon as they accept, their profile shows up here with conversion and capacity stats."
                compact
                data-testid="org-admin-no-agents"
              />
            ) : (
            ...
            <CardContent className="space-y-3">
              ...
              {balancesLoading ? (
                ...
                <EmptyState
                  ...
                  description="Vendor balances will appear here as soon as your first lead sale settles. Pending and paid totals refresh nightly."
                  compact
                  data-testid="org-admin-no-vendors"
                />
              ) : (
