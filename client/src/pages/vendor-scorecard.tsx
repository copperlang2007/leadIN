    ...
    <Card>
      ...
      <CardContent>
        {rows.length === 0 ? (
          <EmptyState
            icon={Inbox}
            title="No leads in the last 30 days"
            compact
            data-testid="scorecard-row-empty"
          />
        ) : (
          <Table>
            <TableHeader>
      ...
      <div className="space-y-6 max-w-6xl mx-auto">
        ...
        {!enabled ? (
          <EmptyState
            ...
            description="Enter a vendor id above and we'll pull their 30-day performance breakdown — ingestion volume, conversion rate, dispute rate, and per-source revenue."
            data-testid="scorecard-no-vendor-selected"
          />
        ) : isLoading || !data ? (
