...
ALTER TABLE "referrals" DROP CONSTRAINT "uniq_referral_per_referee";--> statement-breakpoint
ALTER TABLE "referrals" DROP CONSTRAINT "referrals_code_id_referral_codes_id_fk";
--> statement-breakpoint
ALTER TABLE "referrals" DROP CONSTRAINT "referrals_referee_user_id_users_id_fk";
--> statement-breakpoint
...
CREATE INDEX "idx_referrals_referred_user" ON "referrals" USING btree ("referred_user_id");--> statement-breakpoint
